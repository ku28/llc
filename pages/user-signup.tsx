    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-800">
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-white">Email or Phone Number *</label>
                            <input 
                                required 
                                value={emailOrPhone} 
                        ...
                        {!otpSent ? (
                            <button 
                                ...
                                className="w-full px-6 py-3 bg-brand text-white rounded-lg font-bold hover:bg-brand-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                            ...
                            <>
                                <div>
                                    ...
                                    <input 
                                        ...
                                        maxLength={4}
                                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand focus:border-brand text-center text-2xl tracking-widest"
                                    />
                                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                ...
                                <div className="flex gap-3">
                                    <button 
                                        ...
                                        onClick={sendOTP}
                                        disabled={otpLoading}
                                        className="px-4 py-3 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                                    >
                                        {otpLoading ? 'Resending...' : 'Resend OTP'}
                                    </button>
                                    <button 
                                        disabled={loading || otp.length !== 4} 
                                        className="flex-1 px-6 py-3 bg-brand text-white rounded-lg font-bold hover:bg-brand-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
